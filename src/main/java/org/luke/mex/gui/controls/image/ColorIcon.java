package org.luke.mex.gui.controls.image;

import org.luke.mex.gui.NodeUtils;
...
public class ColorIcon extends StackPane implements Styleable {
	...
	public void setImage(String name, double loadSize, double displaySize) {
		...
		Image img = loadSize == displaySize ? ImageProxy.load(name, loadSize) : ImageProxy.loadResize(name, loadSize, displaySize);
